...
function harness(idType='bigint',noKey=false){
 ...
 vm.runInNewContext(code,{exports:module.exports,require:name=>({'react':hooks,'antd':antd,'@ant-design/icons':new Proxy({},{get:(_,name)=>name}),'./data':data,'./merge':merge,'./bridge':{request},'./DataMergePanel':{DataMergePanel:'MergePanel'},'react/jsx-runtime':{jsx,jsxs:jsx,Fragment:'Fragment'}}[name]),setTimeout:()=>1,clearTimeout(){}});
